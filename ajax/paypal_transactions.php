...
*/
$environment = strstr($CFG->paypallink,"sandbox") ? 'sandbox' : 'live';
...
function PPHttpPost($methodName_, $nvpStr_) {
	...
	$API_UserName = urlencode($CFG->paypal_user);
	$API_Password = urlencode($CFG->paypal_pass);
	$API_Signature = urlencode($CFG->paypal_sig);
...
if("SUCCESS" == strtoupper($httpParsedResponseAr["ACK"]) || "SUCCESSWITHWARNING" == strtoupper($httpParsedResponseAr["ACK"])) {
    echo display_paypal_transaction($httpParsedResponseAr); 
} else  {
